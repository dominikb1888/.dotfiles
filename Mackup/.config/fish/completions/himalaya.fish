...
complete -c himalaya -n "__fish_use_subcommand" -f -a "flags" -d 'Handles flags'
...
complete -c himalaya -n "__fish_seen_subcommand_from flags" -s h -l help -d 'Prints help information'
complete -c himalaya -n "__fish_seen_subcommand_from flags" -s V -l version -d 'Prints version information'
complete -c himalaya -n "__fish_seen_subcommand_from flags" -f -a "set" -d 'Replaces all message flags'
complete -c himalaya -n "__fish_seen_subcommand_from flags" -f -a "add" -d 'Appends flags to a message'
complete -c himalaya -n "__fish_seen_subcommand_from flags" -f -a "remove" -d 'Removes flags from a message'
complete -c himalaya -n "__fish_seen_subcommand_from flags" -f -a "help" -d 'Prints this message or the help of the given subcommand(s)'
